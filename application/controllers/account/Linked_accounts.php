...
class Linked_accounts extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('account/Account_model', 'account/Account_facebook_model', 'account/Account_twitter_model', 'account/Account_openid_model', 'account/Account_linkedin_model'));
