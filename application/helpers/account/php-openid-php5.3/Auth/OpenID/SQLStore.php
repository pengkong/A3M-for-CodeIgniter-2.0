...
class Auth_OpenID_SQLStore extends Auth_OpenID_OpenIDStore {
	...
	function _verifySQL()
	{
		...
		$required_sql_keys = array('nonce_table', 'assoc_table', 'set_assoc', 'get_assoc', 'get_assocs', 'remove_assoc');
	...
	{
		return $this->connection->query($this->sql['set_assoc'], array($server_url, $handle, $secret, $issued, $lifetime, $assoc_type));
	}
