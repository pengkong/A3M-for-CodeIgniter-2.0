...
set_include_path(APPPATH.'modules/account/helpers/php-openid-php5.3/'.PATH_SEPARATOR.get_include_path());
...
/* Location: ./application/modules/account/helpers/openid_helper.php */